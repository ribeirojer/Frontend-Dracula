    ...
    <>
      <HeroSection>
        <Carrousel>
          ...
          <p>
            Somos uma loja especializada em artigos decorativos e presentes
            feitos com corte e impressão a laser, trabalhamos com acrílicos, MDF
            e madeiras finas.
          </p>
          <p>Quer presentear alguém? aqui é o lugar certo!</p>
          <Link to={"/produtos"}>
            <Button cor="" texto="Ver produtos" />
          </Link>
        </Carrousel>
      ...
      <CorteImpressaoSection>
        <CardA>
          ...
          <CardInfo>
            <h2>Corte</h2>
            <p>
              Laboratório de corte, escolha o texto e a fonte da letra caixa do
              seu próprio jeito.
            </p>
            <Link to={"/corte"}>
        ...
        <CardA>
          ...
          <CardInfo>
            <h2>Impressão</h2>
            <p>
              Laboratório de impressão, envie suas imagens e altere o tamanho
              deixando do seu próprio jeito.
            </p>
            <Link to={"/impressao"}>
              <Button cor="#a86815" texto="Experimentar" />
            </Link>
        ...
        <DWrapper>
          <div>
            <p>
              ...
              tenetur repellendus blanditiis provident, ipsum iusto deserunt
              cum, a ullam, minima vitae numquam animi asperiores delectus
              fugiat harum repellat quasi assumenda.
            </p>
            <h3>José Eduardo</h3>
            <p>Dono de Padaria</p>
          </div>
